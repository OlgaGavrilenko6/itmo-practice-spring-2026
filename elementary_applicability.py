...
def main():
    ...
    input_json_path = Path("itmo-practice-spring-2026/requirements_selected_with_global_context_gpt.json")
    output_json_path = Path("applicability_with_context_gpt_v2.json")
